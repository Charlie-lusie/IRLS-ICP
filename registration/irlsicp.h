...
#ifndef PCL_IRLSICP_H_
#define PCL_IRLSICP_H_
...
namespace pcl
{
	...
	*/
	...
	class IRLSIterativeClosestPoint : public IterativeClosestPoint<PointSource, PointTarget>
	{
	public:
			...
			, max_inner_iterations_(20)
		{
			...
			reg_name_ = "IRLSIterativeClosestPoint";
			max_iterations_ = 200;
			transformation_epsilon_ = 5e-4;
			corr_dist_threshold_ = 5.;
			rigid_transformation_estimation_ =
				boost::bind(&IRLSIterativeClosestPoint<PointSource, PointTarget>::estimateRigidTransformationBFGS,
				this, _1, _2, _3, _4, _5);
		}
		...
		*/
		PCL_DEPRECATED("[pcl::registration::IRLSIterativeClosestPoint::setInputCloud] setInputCloud is deprecated. Please use setInputSource instead.")
			void
